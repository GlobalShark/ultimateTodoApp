...
class Dashboard extends Component {
    ...
    _submitTodo(){
        ...
        // allTodos.push(typedTodo)
        var typedTodo = this.state.todo;
        const addTodo = {
            typedTodo
        };
            axios.post(`http://localhost:5050/addTodo`, {addTodo })
            .then(res=>{
                console.log('res',res)
            })
    }
                                                     ...
                                                     {/* &nbsp; &nbsp; */}
                                                                ...
                                                                {/* <br/>  */}
                                                                 ...
                                                                 <div className="row">
                                                                    ...
                                                                    <Button variant="contained" color="primary" className={classes.button} onClick={this._submitTodo.bind(this)}>
                                                                            Add
                                                                    </Button>
